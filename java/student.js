...
const table__student = document.querySelector(".cuerpo-web"); // Ajustado a tu HTML
...
form__student_delete.addEventListener("submit", (e) => {
    ...
    if (actions === "delete") {
        ...
        table__student.innerHTML = ""; // Asegurar que la tabla se vacíe antes de mostrar los nuevos datos
        showRowsTable(DB);
